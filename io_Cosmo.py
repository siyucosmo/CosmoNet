...
def readDataSet(filenames):
    ...
    #normalize
    NbodySimus_batch /= (tf.reduce_sum(NbodySimus_batch, axis=(1,2,3))/(64**3)+.0)[:,None,None,None,:]
    label_batch = (label_batch-tf.constant([2.995679839999998983e-01,8.610806619999996636e-01],dtype = tf.float64))/tf.constant([2.905168635566176411e-02,4.023372385668218254e-02],dtype = tf.float64)
